                    ...
                    <div className='flex flex-wrap py-4'>
                        ...
                        <div className='flex flex-col justify-center items-center border-2 border-secondary rounded-lg mx-auto max-w-lg sm:max-w-2xl'>
                            <div id="visi" className='mx-auto text-center pt-2 pb-3 px-2'>
                                <h1 className='font-bold text-xl text-primary font-sans py-1 sm:text-3xl phone:text-base'>Visi</h1>
                                <p className='font-semibold text-lg text-white sm:text-xl text-start sm:text-center phone:text-xs'>Terwujudnya masyarakat madani yang berbasis masjid dengan berorientasi pada keridha'an Allah SWT.</p>
                            </div>
                            <div></div>
                            <div id="misi" className='mx-auto text-center pt-2 pb-3 px-2 sm:my-8'>
                                <h1 className='font-bold text-xl text-primary font-sans py-1 text-center sm:text-3xl phone:text-base'>Misi</h1>
                                <div className='text-center'>
                                    <ol className='font-semibold text-lg text-white text-start sm:text-center sm:text-xl phone:text-xs'>
